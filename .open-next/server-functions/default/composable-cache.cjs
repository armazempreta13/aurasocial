globalThis.disableIncrementalCache = false;globalThis.disableDynamoDBCache = false;globalThis.nextVersion = "15.1.0";globalThis.openNextDebug = false;globalThis.openNextVersion = "3.10.1";
